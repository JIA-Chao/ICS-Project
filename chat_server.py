...
class Server:
    def __init__(self):
        ...
        self.indices = {}  # map a client's name to its chat index
        # sonnet
...
# ==============================================================================
                ...
                messages = text_proc(msg["message"], from_name)
                self.indices[from_name].add_msg_and_index(messages)

                for g in the_guys:
                    to_sock = self.logged_name2sock[g]
                    self.indices[g].add_msg_and_index(messages)
                    mysend(
